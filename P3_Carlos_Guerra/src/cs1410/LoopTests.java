...
public class LoopTests
{
    ...
    public void testCountWhitespace ()
    {
        ...
        assertEquals(10, Loops.countWhitespace("one two  three   four    "));
        assertEquals(8, Loops.countWhitespace("one\ttwo\n\nthree   four\n\t"));
    }

    @Test
    public void testAverageTokenLength ()
    {
        assertEquals(0, Loops.averageTokenLength(new Scanner("")), 1e-6);
        assertEquals(3.66666666666667, Loops.averageTokenLength(new Scanner("one two three")), 1e-6);
    }
    ...
    {
        assertEquals(null, Loops.findLineWithToken(new Scanner(""), "hello"));
        assertEquals("hello world", Loops.findLineWithToken(new Scanner("hello world"), "world"));
        assertEquals(null, Loops.findLineWithToken(new Scanner("hello world"), "abc"));
        assertEquals("hello world", Loops.findLineWithToken(new Scanner("hello world"), "world"));
